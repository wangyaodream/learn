...
var file_pb_users_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x46, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x3a, 0x0a,
	0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x31, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x48, 0x65, 0x6c,
	0x70, 0x12, 0x10, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x48, 0x65, 0x6c, 0x70, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x48, 0x65, 0x6c, 0x70, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x13, 0x5a, 0x11, 0x62, 0x69, 0x64,
	0x69, 0x2d, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_pb_users_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pb_users_proto_goTypes = []any{
	(*User)(nil),            // 0: User
	(*UserHelpRequest)(nil), // 1: UserHelpRequest
	(*UserHelpReply)(nil),   // 2: UserHelpReply
}
var file_pb_users_proto_depIdxs = []int32{
	0, // 0: UserHelpRequest.user:type_name -> User
	1, // 1: Users.GetHelp:input_type -> UserHelpRequest
	2, // 2: Users.GetHelp:output_type -> UserHelpReply
...
func file_pb_users_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_users_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pb_users_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pb_users_proto_msgTypes[2].Exporter = func(v any, i int) any {
