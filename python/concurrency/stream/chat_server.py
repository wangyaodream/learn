...
class ChatServer:
    ...
    async def _remove_user(self, username: str):
        ...
        try:
            ...
            logging.exception("Error closing client writer,ignoreing...", exc_info=e)
    ...
    async def _listen_for_messages(self, username: str, reader: StreamReader):
        try:
            ...
            logging.exception("Error reading from client,disconnecting...", exc_info=e)
    ...
    async def _notify_all(self, message: str):
        ...
        for username, writer in self._username_to_writer.items():
            try:
                ...
                logging.exception("Error writing to client,disconnecting...", exc_info=e)
...
async def main():
    ...
    await chat_server.start_chat_server('127.0.0.1', 8888)
